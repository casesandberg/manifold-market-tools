    ...
    return (
      <div className="p-6 text-center">
        ...
        <p className="mt-2 text-xs text-zinc-700">
          Nothing found for <strong className="break-words font-semibold text-zinc-900">&lsquo;{query}&rsquo;</strong>.
          Please try again.
        </p>
      </div>
    )
...
export function Search() {
  ...
  return (
    <div className="hidden w-60 md:block md:flex-auto">
      <button
        type="button"
        className="ui-not-focus-visible:outline-none hidden h-8 w-full items-center gap-2 rounded-full bg-white pl-2 pr-3 text-sm text-zinc-500 ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 md:flex"
        {...buttonProps}
      >
        <SearchIcon className="h-5 w-5 stroke-current" />
        Search markets...
        <kbd className="text-2xs ml-auto text-zinc-400">
...
export function MobileSearch() {
  ...
  return (
    <div className="contents md:hidden">
      <button
        type="button"
        className="ui-not-focus-visible:outline-none flex h-6 w-6 items-center justify-center rounded-md transition hover:bg-zinc-900/5 md:hidden"
