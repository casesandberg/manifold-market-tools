...
function SocialLink({
  ...
  return (
    <Link href={href} className="group">
      ...
      <Icon className="h-5 w-5 fill-zinc-700 transition group-hover:fill-zinc-900" />
    </Link>
  )
}
...
function SmallPrint() {
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row">
      <p className="text-xs text-zinc-600">&copy; Copyright {new Date().getFullYear()}. All rights reserved.</p>
